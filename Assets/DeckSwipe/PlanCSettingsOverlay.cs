...
namespace DeckSwipe.World {
	...
	public class PlanCSettingsOverlay : MonoBehaviour {
		...
		private void CreateDimBackground(RectTransform parent) {
			...
			image.color = new Color(0.0f, 0.0f, 0.0f, 0.72f);
		...
		private void CreatePanel(RectTransform parent) {
			...
			panelRect.sizeDelta = new Vector2(330.0f, 360.0f);

			Image panelImage = panelObject.AddComponent<Image>();
			panelImage.color = new Color(0.11f, 0.09f, 0.06f, 0.96f);
			...
			CreateText(
				...
				"Settings",
				28,
				new Vector2(0.0f, 135.0f),
				new Vector2(280.0f, 42.0f),
				Color.white
			);
			...
			CreateCloseButton(panelRect, new Vector2(0.0f, -135.0f));
		...
		private Slider CreateVolumeRow(
			...
			rowRect.sizeDelta = new Vector2(280.0f, 52.0f);
			...
			CreateText(
				...
				label,
				15,
				new Vector2(-60.0f, 14.0f),
				new Vector2(170.0f, 24.0f),
				Color.white,
			...
			valueText = CreateText(
				...
				"100%",
				14,
				new Vector2(105.0f, 14.0f),
				new Vector2(70.0f, 24.0f),
				new Color(0.85f, 0.85f, 0.85f, 1.0f),
				TextAlignmentOptions.Right
			);

			return CreateSlider(rowRect, new Vector2(0.0f, -12.0f));
		}
		...
		private Slider CreateSlider(RectTransform parent, Vector2 anchoredPosition) {
			...
			sliderRect.sizeDelta = new Vector2(260.0f, 22.0f);
			...
			backgroundImage.color = new Color(0.25f, 0.25f, 0.25f, 1.0f);
			...
			fillAreaRect.offsetMin = new Vector2(6.0f, 0.0f);
			fillAreaRect.offsetMax = new Vector2(-6.0f, 0.0f);
			...
			fillImage.color = new Color(0.95f, 0.78f, 0.38f, 1.0f);
			...
			handleRect.sizeDelta = new Vector2(22.0f, 22.0f);
		...
		private void CreateCloseButton(RectTransform parent, Vector2 anchoredPosition) {
			...
			buttonRect.sizeDelta = new Vector2(180.0f, 42.0f);

			Image image = buttonObject.AddComponent<Image>();
			image.color = new Color(0.86f, 0.78f, 0.65f, 1.0f);
